    ...
    <header className="sticky top-0 z-99999 flex w-full border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link href="/dashboard" className="lg:hidden" aria-label="Competency Assessment">
            <MobileBrandLogo />
          </Link>

          <div className="hidden lg:block">
            <h1 className="text-lg font-semibold text-gray-800 dark:text-white/90">Competency Assessment</h1>
            <p className="text-xs text-gray-500 dark:text-gray-400">ระบบประเมินสมรรถนะบุคลากร</p>
          </div>
        ...
        <div className={`${isApplicationMenuOpen ? "flex" : "hidden"} w-full items-center justify-between gap-4 px-5 py-4 shadow-theme-md dark:border-gray-800 lg:flex lg:justify-end lg:px-0 lg:shadow-none`}>
          <ThemeToggleButton />
          <UserDropdown />
        </div>
      </div>
